...
from .views import schedule_practice_view, game_data_view, player_practice_schedule_view, player_game_schedule_view, university_teams_view, schedule_game_view, update_game_details_view
